...
import es.neifi.controlfit.registrohorario.service.RegistroHorarioService;
...
public class TimeTableController {
	...
	public ResponseEntity<String> calculateHours(@RequestBody RegistroHorario registroHorarioCompleto) {
		...
		return ResponseEntity.accepted().body(RegistroHorarioService.calcularDiferenciaHoras(format, entry, exit));
	}
